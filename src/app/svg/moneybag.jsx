...
const Moneybag = (props) => (
  ...
  >
    ...
    <g fill="#f9f3d9">
      <path d="M19 52.2s-2.3 3-7.3 7.1L12 62l-3.5-.8l-.2-2.9s5.1-4.7 6.2-7c-.1 0 1.7.6 4.5.9" />
      <path d="M42.1 51.5s.9 2.4 7.7 6.8v2.9l3.9-1.2v-3s-4.7-3.3-7.5-6.6l-4.1 1.1" />
    </g>
    <path
      fill="#699635"
    ...
    />
    <g fill="#dbb471">
      <path d="M52.4 52.4l-.1 3l3.5-1l.1-3.2c0 .1-2.1.9-3.5 1.2" />
      <path d="M49.8 58.4v2.9l3.9-1.2v-3c-.1-.1-1.1.5-3.9 1.3" />
      <path d="M11.7 59.2L12 62l-3.5-.8l-.2-2.9c-.1 0 1.3.5 3.4.9" />
    </g>
  </svg>
);
